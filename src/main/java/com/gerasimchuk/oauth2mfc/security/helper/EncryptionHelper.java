...
public class EncryptionHelper {
    ...
    @SneakyThrows
    public SecretKey generateKey(@NonNull char[] password, @NonNull byte[] salt) {
    ...
    @SneakyThrows
    public byte[] encrypt(@NonNull SecretKey key, @NonNull byte[] clearText) {
    ...
    @SneakyThrows
    public byte[] decrypt(@NonNull SecretKey key, @NonNull byte[] cipherText) {
